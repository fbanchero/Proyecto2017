...
public class ImageImpl extends ViewElementImpl implements Image {
	...
	protected EClass eStaticClass() {
		return ExtensionsPackage.Literals.IMAGE;
	}
	...
	public void setAlign(String newAlign) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IMAGE__ALIGN, oldAlign, align));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionsPackage.IMAGE__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionsPackage.IMAGE__ALIGN:
				return getAlign();
