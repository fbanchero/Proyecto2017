	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExtensionsPackage.SLOT: {
				...
				if (result == null) result = caseUml_Element(slot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExtensionsPackage.SELECT_EVENT: {
				...
				if (result == null) result = caseUml_Element(selectEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExtensionsPackage.SUBMIT_EVENT: {
				...
				if (result == null) result = caseUml_Element(submitEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.SELECTOR: {
				...
				if (result == null) result = caseUml_Element(selector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExtensionsPackage.WINDOW: {
				...
				if (result == null) result = caseUml_Element(window);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
