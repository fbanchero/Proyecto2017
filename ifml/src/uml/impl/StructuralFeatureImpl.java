 ...
 * </p>
 * <ul>
 *   <li>{@link uml.impl.StructuralFeatureImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructuralFeatureImpl extends ElementImpl implements StructuralFeature {
	/**
		...
		if (primitiveType != null && primitiveType.eIsProxy()) {
			...
			if (primitiveType != oldPrimitiveType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.STRUCTURAL_FEATURE__PRIMITIVE_TYPE, oldPrimitiveType, primitiveType));
			}
		}
	...
	public void setPrimitiveType(PrimitiveType newPrimitiveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.STRUCTURAL_FEATURE__PRIMITIVE_TYPE, oldPrimitiveType, primitiveType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UmlPackage.STRUCTURAL_FEATURE__PRIMITIVE_TYPE:
