 ...
 * </p>
 * <ul>
 *   <li>{@link ifml.core.impl.ContentModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentModelImpl extends NamedElementImpl implements ContentModel {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<Element>(Element.class, this, CorePackage.CONTENT_MODEL__ELEMENTS);
		}
		return elements;
	}
